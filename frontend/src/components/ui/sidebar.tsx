...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen pointer-events-auto">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold">Jagriti Admin</p>
                    <p className="text-sm text-gray-500">admin@jagriti.com</p>
                  </div>
                </div>
              </div>
              {/* Navigation Section */}
      ...
      {/* Desktop Sidebar */}
      <div className="hidden md:flex flex-col fixed top-0 left-0 h-full w-64 bg-white text-black shadow z-50">
        {/* Profile Section */}
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden">
      ...
      {/* Main Content Area Placeholder - Removed white bg so map shows underneath */}
      <div className="flex-1 ml-0 md:ml-64 transition-all duration-300 pointer-events-none">
        {/* Top bar for mobile toggle */}
        <div className="p-4 border-b border-gray-200 md:hidden flex justify-between items-center pointer-events-auto bg-white">
